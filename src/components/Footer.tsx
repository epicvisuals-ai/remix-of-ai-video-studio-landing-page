          ...
          <div className="col-span-12 md:col-span-4">
            <div>
              ...
              <p className="text-background/70 leading-relaxed mb-6">
                Epic visuals is a vetted platform where brands find AI creators, based on subscription model or one time payment. LLM based matching algorithm, high quality vetted specialists, flexible subscription model. MCP, API, and webhook algo for new era AI agents workflows.
              </p>
              {/* Social Media Icons */}
